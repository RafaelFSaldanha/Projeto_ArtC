...
int renascentismo(ALLEGRO_DISPLAY* display) {
    ...
    ALLEGRO_BITMAP* img1 = al_load_bitmap("./assets/img/re_monalisa.png");
    ALLEGRO_BITMAP* img2 = al_load_bitmap("./assets/img/re_criacao_de_adao.png");
    ...
    while (true) {
        ...
        al_draw_text(font_tittle, al_map_rgba(0, 0, 0, 70), now_w / 2 - 5, 185 * scale_x, ALLEGRO_ALIGN_CENTER, "Renascentismo");
        al_draw_text(font_tittle, al_map_rgb(0, 0, 0), now_w / 2, 180 * scale_x, ALLEGRO_ALIGN_CENTER, "Renascentismo");
        ...
        al_draw_text(font_text, al_map_rgb(0, 0, 0), now_w / 2 , 320 * scale_y, ALLEGRO_ALIGN_CENTER, "Período artístico e cultural dos séculos XIV ao XVI que marcou a transição da Idade Média");
        al_draw_text(font_text, al_map_rgb(0, 0, 0), now_w / 2 , 350 * scale_y, ALLEGRO_ALIGN_CENTER, "para a Moderna. Caracterizado pelo resgate dos valores da cultura greco-romana,");
        al_draw_text(font_text, al_map_rgb(0, 0, 0), now_w / 2 , 380 * scale_y, ALLEGRO_ALIGN_CENTER, "desenvolvimento da perspectiva, valorização do ser humano (humanismo) e busca pela");
        al_draw_text(font_text, al_map_rgb(0, 0, 0), now_w / 2 , 410 * scale_y, ALLEGRO_ALIGN_CENTER, "perfeição técnica. Principais artistas: Leonardo da Vinci e Michelangelo.");

        al_draw_filled_rectangle(now_w / 4 - 240 , 790 * scale_y, 1680 * scale_x, 840 * scale_y, al_map_rgb(0, 0, 0));
        al_draw_filled_rectangle(now_w / 4 - 235 , 795 * scale_y, 1675 * scale_x, 835 * scale_y, al_map_rgb(74, 130, 172));

        if (mouseX > 284 * scale_x && mouseX < 484 * scale_x && mouseY > 525 * scale_y && mouseY < 775 * scale_y) {
            r = 225;
            g = 190;
            b = 0;
            if (mouseB == 1) {
        ...
        if (mouseX > 552 * scale_x && mouseX < 792 * scale_x && mouseY > 585 * scale_y && mouseY < 715 * scale_y) {
            r = 225;
            g = 190;
            b = 0;
            if (mouseB == 1) {
        ...
        if (mouseX > 840 * scale_x && mouseX < 1080 * scale_x && mouseY > 575 * scale_y && mouseY < 725 * scale_y) {
            r = 225;
            g = 190;
            b = 0;
            if (mouseB == 1) {
        ...
        al_draw_text(font_text, al_map_rgb(r, g, b), now_w / 2, 475 * scale_y, ALLEGRO_ALIGN_CENTER, "Escola de Atenas");
        ...
        if (mouseX > 1128 * scale_x && mouseX < 1368 * scale_x && mouseY > 575 * scale_y && mouseY < 725 * scale_y) {
            r = 225;
            g = 190;
            b = 0;
            if (mouseB == 1) {
        ...
        if (mouseX > 1416 * scale_x && mouseX < 1656 * scale_x && mouseY > 575 * scale_y && mouseY < 725 * scale_y) {
            r = 225;
            g = 190;
            b = 0;
            if (mouseB == 1) {
