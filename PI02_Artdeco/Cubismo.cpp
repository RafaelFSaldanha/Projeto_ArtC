...
int cubismo(ALLEGRO_DISPLAY* display) {
    ...
    while (true) {
        ...
        al_draw_text(font_text, al_map_rgb(0, 0, 0), 400 * scale_x, 475 * scale_y, ALLEGRO_ALIGN_CENTER, "Les Demoiselles d'Avignon");
        ...
        al_draw_text(font_text, al_map_rgb(0, 0, 0), 675 * scale_x, 475 * scale_y, ALLEGRO_ALIGN_CENTER, "Violinista");
        ...
        al_draw_text(font_text, al_map_rgb(0, 0, 0), 955 * scale_x, 475 * scale_y, ALLEGRO_ALIGN_CENTER, "Retrato de Ambroise Vollard");
        ...
        al_draw_text(font_text, al_map_rgb(0, 0, 0), 1255 * scale_x, 475 * scale_y, ALLEGRO_ALIGN_CENTER, "Garrafa de Suze");
        ...
        al_draw_text(font_text, al_map_rgb(0, 0, 0), 1555 * scale_x, 475 * scale_y, ALLEGRO_ALIGN_CENTER, "O Poeta");
