...
int main() {
    ...
    ALLEGRO_FONT* fontTittle = al_load_font("./Cinzel-Regular.ttf", 70, 0);
    ALLEGRO_FONT* fontoptions = al_load_font("./MontserratSubrayada-Regular.ttf", 40, 0);
    ALLEGRO_FONT* fonttext = al_load_font("./MontserratAlternates-Regular.ttf", 50, 0);
    ALLEGRO_TIMER* timer = al_create_timer(1.0 / 60.0);

    ALLEGRO_BITMAP* moldura = al_load_bitmap("./Moldura.png");
